    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F3F7F3] p-4 text-black">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md border border-[#EAF0E6]">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-extrabold text-[#244926] mb-2">Register Admin</h1>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          Sudah punya akun? <Link href="/login" className="text-[#244926] font-semibold hover:underline">Masuk di sini</Link>
        </div>
      </div>
    </div>
  );
